    ...
    public partial class MainWindow : Window
    {
        ...
        private void MouseHook_MouseButton4Down(MSLLHOOKSTRUCT mouseStruct)
        {
            if (listening == 0)
            {
                ...
                KeySelectionTextBox.Text = $"Selected: {"MOUSE BUTTON4"}";

                PushToTalkText.Text = $"Press and Hold MOUSE BUTTON4 to Talk";
                defaultmicdevice.AudioEndpointVolume.Mute = true;
            }
         
            if (selectedmousehook == 5 && listening == 1)
            {
                isTalking = true;
                PushToTalkText.Text = "Talking...";
                defaultmicdevice.AudioEndpointVolume.Mute = false;
        ...
        private void MouseHook_MouseButton3Down(MSLLHOOKSTRUCT mouseStruct)
        {
            if (listening == 0)
            {
                ...
                KeySelectionTextBox.Text = $"Selected: {"MOUSE BUTTON3"}";

                PushToTalkText.Text = $"Press and Hold MOUSE BUTTON3 to Talk";
                defaultmicdevice.AudioEndpointVolume.Mute = true;
            }

            if (selectedmousehook == 4 && listening == 1)
            {
                isTalking = true;
                PushToTalkText.Text = "Talking...";
                defaultmicdevice.AudioEndpointVolume.Mute = false;
